                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <small>
                                            <strong><%= j.getFechaAsistencia() != null ? j.getFechaAsistencia() : "N/A" %></strong>
                                        </small>
                                    </td>
                                    <td>
                                        <span class="badge bg-info">
                                            <%= j.getTipoJustificacion() != null ? j.getTipoJustificacion().getDescripcion() : "N/A" %>
                                        </span>
                                    </td>
                                    <td>
                                                            ...
                                                            <% if (j.tieneDocumento()) { %>
                                                                <div class="mt-3">
                                                                    ...
                                                                    <a href="<%= j.getDocumentoAdjunto() %>" target="_blank" class="btn btn-sm btn-outline-secondary">
                                                                        <i class="bi bi-download"></i> Descargar <%= j.getNombreArchivo() %>
                                                                    </a>
                                                                </div>
                                                            <% } %>
                                                        </div>
                                    ...
                                    <td><%= j.getJustificadorNombre() != null ? j.getJustificadorNombre() : "N/A" %></td>
                                    <td>
