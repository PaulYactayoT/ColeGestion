...
<body>
    ...
    <div class="container mt-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="AsistenciaServlet?accion=verPadre" class="btn btn-secondary">
                ...
                <div class="card">
                    <div class="card-body">
                        <form method="post" action="JustificacionServlet" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                <label for="asistenciaId" class="form-label">Seleccione la ausencia a justificar *</label>
                            ...
                            <div class="mb-3">
                                <label for="archivo" class="form-label">Documento Adjunto (Opcional)</label>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <a href="AsistenciaServlet?accion=verPadre" class="btn btn-secondary">Cancelar</a>
                            </div>
                        </form>
                    </div>
                </div>
