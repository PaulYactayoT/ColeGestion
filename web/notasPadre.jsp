    ...
    <aside class="w-64 bg-white border-r border-gray-200 hidden md:flex flex-col justify-between fixed h-full z-20">
        <div class="p-6">
            ...
            <nav class="space-y-1">
                ...
                <a href="notasPadre.jsp?alumno_id=<%= alumnoId %>" class="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-primary/10 text-primary font-medium transition-colors">
                    <span class="material-symbols-outlined fill-1">grade</span>
        ...
        <header class="bg-white border-b border-gray-200 sticky top-0 z-10 px-8 py-3 flex justify-between items-center">
            <div class="flex items-center gap-3">
                ...
                <div class="flex items-center gap-2 text-slate-800">
                    ...
                    <h1 class="text-xl font-bold">Calificaciones</h1>
                </div>
            </div>
        ...
        <div class="p-6 md:p-8 max-w-7xl mx-auto w-full">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                ...
                <div class="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                    <h3 class="font-bold text-slate-700">Detalle de Evaluaciones</h3>
                    <div class="flex gap-2">
                        <span class="text-xs text-slate-500 bg-white border px-2 py-1 rounded">Todas las asignaturas</span>
                    </div>
                </div>
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm text-slate-700">
                            ...
                            <% if (notas != null && !notas.isEmpty()) { 
                                for (Nota nota : notas) {
                                    ...
                                    // Si getNota() devuelve un double, usamos casting directo.
                                    // Si tu base de datos devuelve String, usa Double.parseDouble().
                                    // Aquí asumimos que devuelve un número basado en el error anterior.
                                    
                                    double valorNota = 0.0;
                                    try {
                                        // Intentamos obtener como número
                                    ...
                                    String colorNota = "text-slate-700";
                                    String badgeEstado = "bg-green-100 text-green-700 border-green-200";
                                    String textoEstado = "Aprobado";
                                    String iconoEstado = "check_circle";
                                    
                                    if (valorNota < 11) {
                                        colorNota = "text-red-600 font-bold";
                                        badgeEstado = "bg-red-100 text-red-700 border-red-200";
                                        textoEstado = "Desaprobado";
                                        iconoEstado = "cancel";
                                    } else if (valorNota < 14) {
                                        colorNota = "text-orange-600 font-bold";
                                        badgeEstado = "bg-orange-100 text-orange-700 border-orange-200";
                                        textoEstado = "Regular";
                                        iconoEstado = "info";
                                    } else {
                                        colorNota = "text-blue-600 font-bold";
                                        badgeEstado = "bg-blue-100 text-blue-700 border-blue-200";
                                ...
                                <td colspan="4" class="px-6 py-12 text-center text-slate-500">
                                    <div class="flex flex-col items-center justify-center">
                                        <div class="bg-gray-50 p-4 rounded-full mb-3">
                                            <span class="material-symbols-outlined text-4xl text-gray-300">grade_off</span>
                                        </div>
