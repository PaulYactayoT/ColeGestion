                    ...
                    <div class="bg-white dark:bg-card-dark rounded-xl border border-[#dbdfe6] dark:border-gray-700 shadow-sm overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            %>
                                    ...
                                    <table class="availability-table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span style="font-weight: 600; color: #1f2937;" class="dark:text-white">
                                                        <%= disp.getDiaSemana() %>
                                                    </span>
                                                </td>
                                                ...
                                                <td>
                                                    <span style="font-family: 'Courier New', monospace; 
                                                                 font-weight: 600; color: #135bec; font-size: 1rem;" 
                                                ...
                                                <td>
                                                    <% if (disp.getObservaciones() != null && 
                                                        ...
                                                        <small style="color: #6b7280; font-style: italic;" class="dark:text-gray-400">
                                                            <%= disp.getObservaciones() %>
                                                        </small>
                                                    <% } else { %>
                                                        <small style="color: #9ca3af;" class="dark:text-gray-500">Sin observaciones</small>
                                                    <% } %>
                                                </td>
                                            </tr>
                                            <% } %>
                                ...
                                <div class="mt-6 p-4" style="background: #f9fafb; border-radius: 10px;" class="dark:bg-gray-800">
                                    <h6 style="color: #135bec; font-weight: 600; margin-bottom: 1rem;" class="dark:text-blue-300">
                            ...
                            <% } else { %>
                                ...
                                <div class="text-center py-8">
                                    <div style="font-size: 4rem; color: #e5e7eb; margin-bottom: 1rem;" class="dark:text-gray-700">
                                        <i class="fas fa-calendar-times"></i>
                                    </div>
                                    <h5 style="color: #6b7280; font-weight: 600;" class="dark:text-gray-400">
                                        No hay disponibilidad horaria registrada
                                    </h5>
                                    <p style="color: #9ca3af; margin-bottom: 1.5rem;" class="dark:text-gray-500">
