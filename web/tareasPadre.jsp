<%-- 
    Document   : tareasPadre
    Created on : 31 may. 2025, 1:02:07 p. m.
    Author     : Juan Pablo Amaya
--%>

<%@ page contentType="text/html; charset=UTF-8" %>
<%@ page import="java.util.List, modelo.Tarea, modelo.Padre" %>
<%@ page import="modelo.TareaDAO" %>

<%
    // Obtener el ID del alumno desde la URL
    int alumnoId = Integer.parseInt(request.getParameter("alumno_id"));

    // Crear un objeto TareaDAO para acceder a las tareas
    TareaDAO tareaDAO = new TareaDAO();

    // Obtener la lista de tareas para este alumno
    List<Tarea> tareas = tareaDAO.listarPorAlumno(alumnoId);
    ...
    <body>
        ...
        <div class="container mt-5">
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-success text-white">Tareas del Alumno</div>
